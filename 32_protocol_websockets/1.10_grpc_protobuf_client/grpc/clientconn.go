...
import (
	...
	"gpc/grpc/balancer"
	"gpc/grpc/balancer/base"
	"gpc/grpc/codes"
	"gpc/grpc/connectivity"
	"gpc/grpc/credentials"
	"gpc/grpc/internal/backoff"
	"gpc/grpc/internal/channelz"
	"gpc/grpc/internal/grpcsync"
	"gpc/grpc/internal/grpcutil"
	"gpc/grpc/internal/transport"
	"gpc/grpc/keepalive"
	"gpc/grpc/resolver"
	"gpc/grpc/serviceconfig"
	"gpc/grpc/status"

	_ "gpc/grpc/balancer/roundrobin"           // To register roundrobin.
	_ "gpc/grpc/internal/resolver/dns"         // To register dns resolver.
	_ "gpc/grpc/internal/resolver/passthrough" // To register passthrough resolver.
)
